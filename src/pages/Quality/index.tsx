            ...
            <QueryResult result={queryResult}>
              <div className={'py-3'}>
                ...
                <Row>
                  ...
                  <Col span={12}>
                    <Statistic title="价格空值占比" value={queryResult.data.costNullRate} />
                  </Col>
                </Row>
                <Row>
                  <Col span={12}>
                  ...
                  <Col span={12}>
                    <Statistic title="评论数量属性空值占比" value={queryResult.data.commentsNullRate} />
                  </Col>
                </Row>
                <Row>
                  <Col span={12}>
                  ...
                  <Col span={12}>
                    <Statistic title="版本属性空值占比" value={queryResult.data.formatNullRate} />
                  </Col>
                </Row>
                <Row>
                  <Col span={12}>
                  ...
                  <Col span={12}>
                    <Statistic title="类型属性空值占比" value={queryResult.data.typeNullRate} />
                  </Col>
                </Row>
                <Row>
                  <Col span={12}>
                  ...
                  <Col span={12}>
                    <Statistic title="评分属性空值占比" value={queryResult.data.gradeNullRate} />
                  </Col>
                </Row>
                <Row>
                  <Col span={12}>
                  ...
                  <Col span={12}>
                    <Statistic title="时长属性空值占比" value={queryResult.data.timeNullRate} />
                  </Col>
                </Row>
              </div>
            </QueryResult>
